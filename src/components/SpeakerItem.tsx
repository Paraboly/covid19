    ...
    return (
        <>
            <IonCard className="speaker-card">
                <IonCardHeader>
                    ...
                    >
                        <IonAvatar slot="start">
                            <img
                                src={
                                    process.env.PUBLIC_URL + speaker.profilePic
                                }
                ...
                <IonRow justify-content-center={true}>
                    <IonCol text-left={true} size="4">
                        <IonButton
                            fill="clear"
                            size="small"
                            color="primary"
                    ...
                    <IonCol text-left={true} size="4">
                        <IonButton
                            ...
                            size="small"
                            color="primary"
                            onClick={() => openSpeakerShare(speaker)}
                        >
