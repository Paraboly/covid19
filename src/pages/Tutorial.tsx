        ...
        <IonPage id="tutorial-page">
            ...
            <IonContent fullscreen={true}>
                ...
                >
                    <IonSlide>
                        <img
                            src="assets/img/tutorial-slidebox-img-1.svg"
                            alt=""
                        ...
                        <p>
                            Using <b>Corona City Tracker for Turkey</b> get
                    ...
                    <IonSlide>
                        <img
                            src="assets/img/tutorial-slidebox-img-2.svg"
                            alt=""
                            className="slide-image"
                        />
                        <h2 className="slide-title">
                            Get live information ℹ️, take basic precautions 🧼
                            and stay healthy🤗
                        </h2>
                    </IonSlide>
                    ...
                    <IonSlide>
                        <img
                            src="assets/img/tutorial-slidebox-img-3.svg"
                            alt=""
                            className="slide-image"
                        />
