            ...
            <IonContent>
                <div className="ion-padding">
                    ...
                    <IonText color="medium">
                        <Time date={session.dateTimeStart} /> &ndash;{" "}
                ...
                <IonList>
                    ...
                    <IonItem
                        onClick={() => sessionClick("add to calendar")}
                        button={true}
                    >
                        <IonLabel color="primary">Add to Calendar</IonLabel>
                    </IonItem>
                    <IonItem
                        onClick={() => sessionClick("mark as unwatched")}
                        button={true}
                    >
                        <IonLabel color="primary">Mark as Unwatched</IonLabel>
                    </IonItem>
                    <IonItem
                        onClick={() => sessionClick("download video")}
                        button={true}
                    >
                    ...
                    <IonItem
                        onClick={() => sessionClick("leave feedback")}
                        button={true}
                    >
